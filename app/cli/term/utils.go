...
func GetTerminalWidth() int {
	...
	if os.Getenv("PLANTO_COLUMNS") != "" {
		w, err := strconv.Atoi(os.Getenv("PLANTO_COLUMNS"))
		if err == nil {
			envReplCols = w
			return w
		}
...
func GetStreamForegroundColor() termenv.Color {
	...
	if os.Getenv("PLANTO_STREAM_FOREGROUND_COLOR") != "" {
		envStreamForegroundColor = termenv.ANSI256.Color(os.Getenv("PLANTO_STREAM_FOREGROUND_COLOR"))
		return envStreamForegroundColor
	}
