			...
			original: `
{
  "name": "vscode-planto",
  "displayName": "Planto",
  "description": "VSCode extension for Planto integration",
  "version": "0.1.0",
  "engines": {
    "vscode": "^1.80.0"
  },
  ...
  "contributes": {
    ...
    "keybindings": [{
      ...
      "key": "@",
      "when": "editorTextFocus && editorLangId == planto"
    }]
  },
  "scripts": {
			...
			proposed: `
{
  ...
  "contributes": {
    "languages": [{
      ...
      "icon": {
          "light": "./icons/planto-light.png",
          "dark": "./icons/planto-dark.png"
      }
    }],
    "grammars": [{
      "language": "planto",
      "scopeName": "text.planto",
      "path": "./syntaxes/planto.tmLanguage.json",
      "embeddedLanguages": {
