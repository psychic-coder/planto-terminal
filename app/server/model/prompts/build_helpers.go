...
You must analyze the *original file* and the *proposed updates* and output a <PlantoComments> element that lists *EVERY* comment in the *proposed updates*, including the line number of each comment prefixed by 'pdx-new-'. Below each comment, evaluate whether it is a reference comment.
...
If there are no comments in the *proposed updates*, output an empty <PlantoComments> element.
